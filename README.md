...
**Dikkat**: ```9Sinif_4Odev.ipynb``` dosyasını kendi hesabınızdan açınız, benim hesabımdan değil. Benim hesabımdan açarsanız, kendi Github hesabınıza kopyalayamazsınız. 
...
5) Maalesef Colab ile fazla Türkçe kaynağımız yok (İstersen Google'da arat.) Hem Python ile bilgilerini tazelemen hem de Google Colab'ı kullanmanı biraz geliştirmen için [buraya](https://github.com/fuatbeser/python-notlarim) bakabilirsin. Bu depoyu kendi hesabına forklayım, kendi notlarını da oluşturabilirsin. 
